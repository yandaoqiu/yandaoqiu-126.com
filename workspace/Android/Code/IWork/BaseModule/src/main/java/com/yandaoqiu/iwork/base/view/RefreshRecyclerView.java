...
//            跳转到正在刷新
     ...
     * @param isSuccess
     */
    public void onFinishRefresh(final boolean isSuccess) {
        ...
        headerView.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                if (padingY < 0){
                    ...
                    headerView.setPadding(0, -RY+headerView.getPaddingTop(), 0, 0);
                    return;
                }

                headerView.setPadding(0, -10+headerView.getPaddingTop(), 0, 0);
                onFinishRefresh(isSuccess);
            }
        },10);
    }
        ...
        public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
            if (newState == SCROLL_STATE_IDLE || newState == SCROLL_STATE_SETTLING) {
                ...
                if (layoutManager instanceof GridLayoutManager) {
                    ...
                    if (linearLayoutManager.findLastVisibleItemPosition() >= getChildCount() - 1 && linearLayoutManager.findLastVisibleItemPosition() > 2) {
                        isLoadingMore = true;
                        //把底部加载显示
